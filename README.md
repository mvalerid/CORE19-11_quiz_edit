# Comprobador Automático CORE19-11_quiz_edit
...
$
$ cd CORE19-11_quiz_edit  ## Entrar en el directorio de trabajo del programa de test
$
...
$             ## El directorio de trabajo contiene ahora el fichero: CORE19-11_quiz_edit.zip
```

El fichero `CORE19-11_quiz_edit.zip` contiene los ficheros de la practica comprimidos y puede subirse a la plataforma para su evaluación.
